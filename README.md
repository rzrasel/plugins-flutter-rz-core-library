...
dependencies:
  rz_core_library:
    git:
      url: https://github.com/rzrasel/plugins-flutter-rz-core-library.git
      ref: vref-1.0.1
```
...
```dart
import 'package:rz_library_utilities/rz_core_library.dart';
```
...
```bash
git init
git remote add origin https://github.com/rzrasel/plugins-flutter-rz-core-library.git
git remote -v
